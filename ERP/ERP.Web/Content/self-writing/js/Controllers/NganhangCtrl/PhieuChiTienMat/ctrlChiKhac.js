    ...
    ctrlChiKhac.$inject = ['$scope', "$location", '$http', '$uibModal'];
    function ctrlChiKhac($scope, $location, $http, $uibModal) {
        //array tổng hợp
        $scope.arrayTongHop = {
            ma_doi_tuong: '',
            ma_cong_ty: '',
        ...
        */
        $scope.showInfoTKThue = function (p_tkthue) {
            $scope.arraydiengiai[$scope.indexcurrent].tk_thue = p_tkthue.SO_TK;
        }
        ...
        */
        $scope.showInfoNcc = function (p_ncc) {
            $scope.arraydiengiai[$scope.indexcurrent].ma_ncc = p_ncc.MA_NHA_CUNG_CAP;
        }
        ...
        */
        ...
        $scope.onSave = function () {
            ...
            for (var i = 0; i < $scope.arraydiengiai.length; i++) {
                ...
                //    DIEN_GIAI_THUE: $scope.arraydiengiai[i].dien_giai_thue,
                //    TK_THUE_GTGT: $scope.arraydiengiai[i].tk_thue,
                //    TIEN_THUE_GTGT: $scope.arraydiengiai[i].tien_thue,
                //    CK_THUE_GTGT: $scope.arraydiengiai[i].phan_tram_thue,
                //    GIA_TRI_HHDV_CHUA_THUE: $scope.arraydiengiai[i].gia_tri_chua_thue,
                //    NGAY_HD: $scope.arraydiengiai[i].ngay_hoa_don.format('YYYY-MM-DD'),
                //    SO_HD: $scope.arraydiengiai[i].so_hoa_don,
                //    MAU_SO_HD: $scope.arraydiengiai[i].mau_so_hoa_don,
                //    KY_HIEU_HD: $scope.arraydiengiai[i].ky_hieu_hoa_don,
                //    MA_NHA_CUNG_CAP: $scope.arraydiengiai[i].ma_ncc
                //}
                ...
                if ($scope.arraydiengiai[i].dien_giai_thue) {
                    quy_Ct_Phieu_Chi.DIEN_GIAI_THUE = $scope.arraydiengiai[i].dien_giai_thue;
                }

                if ($scope.arraydiengiai[i].tk_thue) {
                    quy_Ct_Phieu_Chi.TK_THUE_GTGT = $scope.arraydiengiai[i].tk_thue;
                }

                if ($scope.arraydiengiai[i].tien_thue) {
                    quy_Ct_Phieu_Chi.TIEN_THUE_GTGT = $scope.arraydiengiai[i].tien_thue;
                }

                if ($scope.arraydiengiai[i].phan_tram_thue) {
                    quy_Ct_Phieu_Chi.CK_THUE_GTGT = $scope.arraydiengiai[i].phan_tram_thue;
                }

                if ($scope.arraydiengiai[i].gia_tri_chua_thue) {
                    quy_Ct_Phieu_Chi.GIA_TRI_HHDV_CHUA_THUE = $scope.arraydiengiai[i].gia_tri_chua_thue;
                }

                if ($scope.arraydiengiai[i].ngay_hoa_don) {
                    quy_Ct_Phieu_Chi.NGAY_HD = $scope.arraydiengiai[i].ngay_hoa_don.format('YYYY-MM-DD');
                }

                if ($scope.arraydiengiai[i].so_hoa_don) {
                    quy_Ct_Phieu_Chi.SO_HD = $scope.arraydiengiai[i].so_hoa_don;
                }

                if ($scope.arraydiengiai[i].mau_so_hoa_don) {
                    quy_Ct_Phieu_Chi.MAU_SO_HD = $scope.arraydiengiai[i].mau_so_hoa_don;
                }

                if ($scope.arraydiengiai[i].ky_hieu_hoa_don) {
                    quy_Ct_Phieu_Chi.KY_HIEU_HD = $scope.arraydiengiai[i].ky_hieu_hoa_don;
                }

                if ($scope.arraydiengiai[i].ma_ncc) {
                    quy_Ct_Phieu_Chi.MA_NHA_CUNG_CAP = $scope.arraydiengiai[i].ma_ncc;
                }
